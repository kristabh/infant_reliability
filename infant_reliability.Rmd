...
```
## Table 1 - Sample size and effect size

```{r}

# Compute necessary sample sizes at different levels of Cohen's d (Table 1) for paired samples/single-sample t-test
...
# Compute necessary sample sizes at different levels of Cohen's d (Table 1) for independent samples t-test
