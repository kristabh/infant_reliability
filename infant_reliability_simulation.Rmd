...
sim_plot <- sim_data %>%
 ...
 # geom_violin() +
  ...
  geom_label(data = true_data_summary, y = -3, label.size = NA, label.padding = unit(.1, "lines"), alpha = 0, vjust = "bottom", nudge_x = .5, size = 3, aes(label = paste("Mean = ", mean, ", sd = ", round(sd, 2), ", d = ", round(d, 2), ", r = ", round(r, 2)))) 
